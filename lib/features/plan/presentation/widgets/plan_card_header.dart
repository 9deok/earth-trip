...
class PlanCardHeader extends StatelessWidget {
  ...
  final int daysLeft;
  const PlanCardHeader({required this.flagAsset, required this.title, required this.daysLeft});
  ...
  Widget build(BuildContext context) => Row(
        children: [
          ...
          Expanded(
            child: Text(title, style: PlanCardStyles.titleStyle, overflow: TextOverflow.ellipsis),
          ),
          const Spacer(),
